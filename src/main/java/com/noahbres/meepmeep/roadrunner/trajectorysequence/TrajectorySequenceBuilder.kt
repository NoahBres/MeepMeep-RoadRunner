...
class TrajectorySequenceBuilder(private val startPose: Pose2d, private val baseConstraints: DriveConstraints, private val trackWidth: Double) {
    ...
    @JvmOverloads
    fun lineToLinearHeading(endPosition: Vector2d, endHeading: Double, constraintsOverride: TrajectoryConstraints = baseConstraints) = addPath {
        currentTrajectoryBuilder!!.lineToLinearHeading(endPosition, endHeading, constraintsOverride)
    }

    @JvmOverloads
    fun lineToSplineHeading(endPosition: Vector2d, endHeading: Double, constraintsOverride: TrajectoryConstraints = baseConstraints) = addPath {
        currentTrajectoryBuilder!!.lineToSplineHeading(endPosition, endHeading, constraintsOverride)
    }
    ...
    @JvmOverloads
    fun splineTo(endPose: Pose2d, constraintsOverride: TrajectoryConstraints = baseConstraints) = addPath {
        currentTrajectoryBuilder!!.splineTo(endPose, constraintsOverride)
    }

    @JvmOverloads
    fun splineToConstantHeading(endPose: Pose2d, constraintsOverride: TrajectoryConstraints = baseConstraints) = addPath {
        currentTrajectoryBuilder!!.splineToConstantHeading(endPose, constraintsOverride)
    }
